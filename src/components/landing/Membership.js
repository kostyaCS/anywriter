...
const Membership = () => {
    ...
    return (
        <Main>
            ...
            <StyledReadersTextSmall>
                Gain access to personalized content and be part of a supportive
                community that embraces creativity in all its forms.
            </StyledReadersTextSmall>
            <MembershipCardsContainer>
                <MembershipCard>
                    ...
                    Tailor your reading experience by requesting topics that resonate with
                    you.
                </MembershipCard>
                <MembershipCard>
                ...
                <MembershipCard>
                    ...
                    Connect with fellow members, share your ideas, and collaborate on
                    exciting projects.
                </MembershipCard>
                <MembershipCard>
                    <StyledFacesImg src={faces} alt="faces" />
                    <MembershipCardMainText>Livestreaming Access</MembershipCardMainText>
                    Enjoy exclusive access to live events and broadcasts, including author
                    interviews, workshops, and discussions.
                </MembershipCard>
                <MembershipCard>
                    <StyledFireImg src={fire} alt="fire" />
                    <MembershipCardMainText>
                        Exclusive Writings & Merch
                    </MembershipCardMainText>
                    Enjoy access to special writings, bonus content, and exclusive
                    merchandise.
                </MembershipCard>
                <MembershipCard>
                    <StyledAsteriskImg src={asterisk} alt="asterisk" />
                    <MembershipCardMainText>And much more!</MembershipCardMainText>
                    Unlock additional perks, surprises, and opportunities to further
                    enrich your Readly experience.
                </MembershipCard>
            </MembershipCardsContainer>
