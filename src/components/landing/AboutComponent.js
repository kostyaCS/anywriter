...
const AboutComponent = () => {
    ...
    return (
        <Main>
            <StyledAboutText>
                Read. Discuss. Get inspired by every minute of it.
            </StyledAboutText>
            <AboutImgContainer>
                <AboutImgCard>
                    <StyledManImage src={man_thinking} alt="man thinking" />
                    <AboutImgCardText>
                        Participate in thought-provoking discussions, absorb inspiring
                        perspectives, and unlock boundless potential for your writing
                        journey.
                    </AboutImgCardText>
                </AboutImgCard>
                <AboutImgCard>
                    ...
                    <AboutImgCardText>
                        Dive into a vibrant community where people come together to explore
                        diverse perspectives, share their stories, and ignite their
                        creativity.
                    </AboutImgCardText>
                </AboutImgCard>
            </AboutImgContainer>
            <AboutReviewContainer>
                ...
                <AboutReviewMain>
                    ...
                    <StyledAboutReviewText>
                        Readly revolutionized my reading. Diverse topics and a supportive
