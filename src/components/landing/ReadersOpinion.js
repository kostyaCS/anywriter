        ...
        <Main>
            ...
            <ReadersCardContainer>
                <ReadersCard>
                    ...
                    <StyledReadersCardText>
                        I found amazing content on various topics. The community here is
                ...
                <ReadersCard>
                    <StyledAboutReviewTextPink>“</StyledAboutReviewTextPink>
                    <StyledReadersCardText>
                        Readly has become my go-to platform for discovering insightful
                        articles. The sense of community here is truly inspiring.
                    </StyledReadersCardText>
                    <StyledReadersPersonTextContainer>
                        <StyledAboutPersonText>
                ...
                <ReadersCard>
                    <StyledAboutReviewTextPink>“</StyledAboutReviewTextPink>
                    <StyledReadersCardText>
                        I've found a treasure trove of engaging content on Readly. It's like
                        having a literary oasis at my fingertips.
                    </StyledReadersCardText>
                    <StyledReadersPersonTextContainer>
                        <StyledAboutPersonText>
