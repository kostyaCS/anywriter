    ...
    return (
        <Main>
            ...
            <MainContainer>
                ...
                <MainContainerImage>
                    <FrameImgContainer>
                        <StyledRecentWritingImage
                            src={avatarUrl || Avatar}
                            alt="ProfileScreen picture"
                        />
                    </FrameImgContainer>
                    <MainContainerInput
                        onChange={(e) => {
                    ...
                    />
                    {successAlertImage && (
                        <TimedAlert message="Image uploaded successfully!" />
                    )}
                ...
                <MainContainerData>
                    ...
                    {successAlertEmail && (
                        <TimedAlert message="Email cannot be updated right now." />
                    )}
                </MainContainerData>
                {invalidEmailMessage && (
                    <InvalidUpdateInput text={invalidEmailMessage} />
                )}
                <MainContainerTitle>Username</MainContainerTitle>
                <MainContainerData>
                    <InputField
                        type="text"
                        placeholder={prevNickname || "Add your nickname"}
                        value={nickname}
                        onChange={(e) => {
                    ...
                    {successAlertNick && (
                        <TimedAlert message="Nickname updated successfully!" />
                    )}
                </MainContainerData>
                {invalidNicknameMessage && (
                    <InvalidUpdateInput text={invalidNicknameMessage} />
                )}
...
const MainContainerInput = styled.input.attrs({
    type: "file",
    id: "files",
    className: "hidden",
})`
